...
/**
 * [ScrollableTabRow]와 유사하지만, 탭의 최소 크기를 제한하지 않는다.
 *
 * @param selectedTabIndex 선택된 탭의 인덱스 (0-index)
 * @param modifier 적용할 [Modifier]
 * @param backgroundColor 탭의 배경색
 * @param contentColor 탭 콘텐츠의 색
 * @param edgePadding 탭의 시작과 끝에 붙일 padding
 * @param indicator 선택된 탭을 나타낼 indicator
 * @param divider 탭 사이를 나눌 divider
 * @param tabs 탭 [Composable]
 */
@Composable
fun KuringScrollableTabRow(
    ...
    indicator: @Composable @UiComposable
        ...
        KuringScrollableTabRowDefaults.Indicator(
            Modifier.kuringTabIndicatorOffset(tabPositions[selectedTabIndex])
        )
    },
    divider: @Composable @UiComposable () -> Unit =
        @Composable {
            KuringScrollableTabRowDefaults.Divider()
        },
...
object KuringScrollableTabRowDefaults {
    @Composable
    fun Divider(
        modifier: Modifier = Modifier,
     ...
     */
    fun Modifier.kuringTabIndicatorOffset(
