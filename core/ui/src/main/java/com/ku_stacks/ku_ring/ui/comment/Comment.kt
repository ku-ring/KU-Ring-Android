package com.ku_stacks.ku_ring.ui.comment
...
import com.ku_stacks.ku_ring.designsystem.R as DesignsystemR
    ...
    Column(
        ...
        comment.replies.forEach { reply ->
            Row(modifier = Modifier.padding(top = 6.dp, end = 7.dp, bottom = 6.dp)) {
                Icon(
                    imageVector = ImageVector.vectorResource(DesignsystemR.drawable.ic_reply_v2),
...
private fun CommentHeader(
    ...
    Row(
        ...
        Icon(
            imageVector = ImageVector.vectorResource(DesignsystemR.drawable.ic_user_v2),
            contentDescription = null,
            tint = KuringTheme.colors.gray300,
        )
        Text(
        ...
        if (!isReply) {
            Icon(
                imageVector = ImageVector.vectorResource(DesignsystemR.drawable.ic_message_circle_v2),
        ...
        Box {
            Icon(
                imageVector = ImageVector.vectorResource(DesignsystemR.drawable.ic_more_vertical_v2),
...
private fun CommentDropdownMenu(
    ...
    DropdownMenu(
        ...
        DropdownMenuItem(
            ...
            trailingIcon = {
                Icon(
                    imageVector = ImageVector.vectorResource(DesignsystemR.drawable.ic_info_circle_mono_v2),
                    contentDescription = null,
                )
            },
        ...
        if (isDeletable) {
            ...
            DropdownMenuItem(
                ...
                trailingIcon = {
                    Icon(
                        imageVector = ImageVector.vectorResource(DesignsystemR.drawable.ic_trashcan_v2),
                        contentDescription = null,
                    )
                },
                modifier = Modifier.clearAndSetSemantics {
