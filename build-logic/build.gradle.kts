...
gradlePlugin {
    plugins {
        ...
        register("com.ku_stacks.ku_ring.buildlogic.primitive.JUnit5TestPlugin") {
            id = "com.ku_stacks.ku_ring.buildlogic.primitive.junit5"
            implementationClass = "com.ku_stacks.ku_ring.buildlogic.primitive.JUnit5TestPlugin"
        }
